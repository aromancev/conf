...
func BuildClues(in, out string) error {
	cmd := exec.Command(
		"mkvmerge",
		"-q",
		"-o", out,
...
// 52500f12-1a84-4af1-be4c-4044ee209af7
// mkvmerge -o clued.webm raw.webm
// ffmpeg -hide_banner -i clued.webm -an -dn -sn -c:v libvpx-vp9 -row-mt 1 -keyint_min 150 -g 150 -tile-columns 4 -frame-parallel 1 -movflags faststart -f webm -dash 1 -speed 3 -threads 4 -an -vf scale=426:240 -b:v 400k -r 30 -dash 1 stream.webm
// ffmpeg -f webm_dash_manifest -i stream.webm -y -c copy -map 0 -f webm_dash_manifest -adaptation_sets id=0,streams=0 manifest.mpd
