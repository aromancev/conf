...
func (x *EventJob) GetMessage() *EventJob_Message {
	if x, ok := x.GetEvent().(*EventJob_Message_); ok {
		return x.Message
	}
	return nil
}
...
type EventJob_Message_ struct {
	Message *EventJob_Message `protobuf:"bytes,11,opt,name=message,proto3,oneof"`
}

func (*EventJob_PeerStatus_) isEventJob_Event() {}

func (*EventJob_Message_) isEventJob_Event() {}
...
func (x *EventJob_Message) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EventJob_Message) ProtoMessage() {}

func (x *EventJob_Message) ProtoReflect() protoreflect.Message {
	mi := &file_queue_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EventJob_Message.ProtoReflect.Descriptor instead.
func (*EventJob_Message) Descriptor() ([]byte, []int) {
	return file_queue_proto_rawDescGZIP(), []int{4, 1}
}

func (x *EventJob_Message) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
var file_queue_proto_rawDesc = []byte{
	...
	0x84, 0x02, 0x0a, 0x08, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4a, 0x6f, 0x62, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x65, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2d, 0x0a, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x4a, 0x6f, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x24, 0x0a, 0x0a, 0x50, 0x65, 0x65, 0x72,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x1d,
	...
	0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_queue_proto_goTypes = []interface{}{
	...
	(*EventJob_Message)(nil),    // 6: EventJob.Message
}
var file_queue_proto_depIdxs = []int32{
	...
	6, // 2: EventJob.message:type_name -> EventJob.Message
