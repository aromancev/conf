...
var file_confa_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_confa_proto_goTypes = []interface{}{
	(*UpdateProfile)(nil),                  // 0: UpdateProfile
	(*UpdateProfile_Source)(nil),           // 1: UpdateProfile.Source
	(*UpdateProfile_Source_Storage)(nil),   // 2: UpdateProfile.Source.Storage
	(*UpdateProfile_Source_PublicURL)(nil), // 3: UpdateProfile.Source.PublicURL
}
var file_confa_proto_depIdxs = []int32{
	1, // 0: UpdateProfile.avatar:type_name -> UpdateProfile.Source
	2, // 1: UpdateProfile.Source.storage:type_name -> UpdateProfile.Source.Storage
	3, // 2: UpdateProfile.Source.public_url:type_name -> UpdateProfile.Source.PublicURL
