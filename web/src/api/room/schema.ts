...
const typeMap: any = {
  ...
  EventMessage: o([{ json: "text", js: "text", typ: "" }], false),
  EventPeerState: o(
    [
  ...
  PeerMessage: o([{ json: "text", js: "text", typ: "" }], false),
  Signal: o(
    [
  ...
  SignalAnswer: o([{ json: "description", js: "description", typ: r("SessionDescription") }], false),
  ...
  SignalOffer: o([{ json: "description", js: "description", typ: r("SessionDescription") }], false),
  SignalTrickle: o(
    [
  ...
  PeerState: o([{ json: "tracks", js: "tracks", typ: u(undefined, a(r("Track"))) }], false),
  Status: ["joined", "left"],
  Hint: ["camera", "device_audio", "screen", "user_audio"],
  SDPType: ["answer", "offer", "pranswer", "rollback"],
}
