...
const (
	TrackKind_AUDIO TrackKind = 0
	TrackKind_VIDEO TrackKind = 1
)
...
const (
	...
	TrackSource_SCREEN       TrackSource = 3
	TrackSource_SCREEN_AUDIO TrackSource = 4
)
...
func (x *Event_Payload) GetTrackRecord() *Event_Payload_TrackRecord {
	if x, ok := x.GetPayload().(*Event_Payload_TrackRecord_); ok {
		return x.TrackRecord
	}
	return nil
}
...
type Event_Payload_TrackRecord_ struct {
	TrackRecord *Event_Payload_TrackRecord `protobuf:"bytes,4,opt,name=track_record,json=trackRecord,proto3,oneof"`
}
...
func (*Event_Payload_TrackRecord_) isEvent_Payload_Payload() {}
...
func (*Event_Payload_PeerState) Descriptor() ([]byte, []int) {
	return file_rtc_proto_rawDescGZIP(), []int{6, 0, 0}
}
...
func (*Event_Payload_Message) Descriptor() ([]byte, []int) {
	return file_rtc_proto_rawDescGZIP(), []int{6, 0, 1}
}
...
func (*Event_Payload_Recording) Descriptor() ([]byte, []int) {
	return file_rtc_proto_rawDescGZIP(), []int{6, 0, 2}
}
...
type Event_Payload_TrackRecord struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RecordId []byte      `protobuf:"bytes,1,opt,name=record_id,json=recordId,proto3" json:"record_id,omitempty"`
	Kind     TrackKind   `protobuf:"varint,3,opt,name=kind,proto3,enum=TrackKind" json:"kind,omitempty"`
	Source   TrackSource `protobuf:"varint,4,opt,name=source,proto3,enum=TrackSource" json:"source,omitempty"`
}

func (x *Event_Payload_TrackRecord) Reset() {
	*x = Event_Payload_TrackRecord{}
	if protoimpl.UnsafeEnabled {
...
func (x *Event_Payload_TrackRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Event_Payload_TrackRecord) ProtoMessage() {}

func (x *Event_Payload_TrackRecord) ProtoReflect() protoreflect.Message {
	mi := &file_rtc_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Event_Payload_TrackRecord.ProtoReflect.Descriptor instead.
func (*Event_Payload_TrackRecord) Descriptor() ([]byte, []int) {
	return file_rtc_proto_rawDescGZIP(), []int{6, 0, 3}
}

func (x *Event_Payload_TrackRecord) GetRecordId() []byte {
	if x != nil {
		return x.RecordId
	}
	return nil
...
func (x *Event_Payload_TrackRecord) GetKind() TrackKind {
	if x != nil {
		return x.Kind
	}
...
func (x *Event_Payload_TrackRecord) GetSource() TrackSource {
	if x != nil {
		return x.Source
	}
...
func (*Event_Payload_Reaction) Descriptor() ([]byte, []int) {
	return file_rtc_proto_rawDescGZIP(), []int{6, 0, 4}
}
...
func (*Event_Payload_Reaction_Reaction) Descriptor() ([]byte, []int) {
	return file_rtc_proto_rawDescGZIP(), []int{6, 0, 4, 0}
}
...
func (*Event_Payload_Reaction_Reaction_Clap) Descriptor() ([]byte, []int) {
	return file_rtc_proto_rawDescGZIP(), []int{6, 0, 4, 0, 0}
}
...
var file_rtc_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xbf, 0x07, 0x0a, 0x05, 0x45,
	...
	,
	...
	,
	...
	,
...
var file_rtc_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_rtc_proto_goTypes = []interface{}{
	(TrackKind)(0),                                  // 0: TrackKind
	(TrackSource)(0),                                // 1: TrackSource
	(*Room)(nil),                                    // 2: Room
	(*RecordingParams)(nil),                         // 3: RecordingParams
	(*RecordingLookup)(nil),                         // 4: RecordingLookup
	(*Recording)(nil),                               // 5: Recording
	(*UpdateRecordingTrack)(nil),                    // 6: UpdateRecordingTrack
	(*StoreEvent)(nil),                              // 7: StoreEvent
	(*Event)(nil),                                   // 8: Event
	(*UpdateRecordingTrack_Update)(nil),             // 9: UpdateRecordingTrack.Update
	(*UpdateRecordingTrack_RecordingStarted)(nil),   // 10: UpdateRecordingTrack.RecordingStarted
	(*UpdateRecordingTrack_RecordingFinished)(nil),  // 11: UpdateRecordingTrack.RecordingFinished
	(*UpdateRecordingTrack_ProcessingStarted)(nil),  // 12: UpdateRecordingTrack.ProcessingStarted
	(*UpdateRecordingTrack_ProcessingFinished)(nil), // 13: UpdateRecordingTrack.ProcessingFinished
	(*Event_Payload)(nil),                           // 14: Event.Payload
	(*Event_Payload_PeerState)(nil),                 // 15: Event.Payload.PeerState
	(*Event_Payload_Message)(nil),                   // 16: Event.Payload.Message
	(*Event_Payload_Recording)(nil),                 // 17: Event.Payload.Recording
	(*Event_Payload_TrackRecord)(nil),               // 18: Event.Payload.TrackRecord
	(*Event_Payload_Reaction)(nil),                  // 19: Event.Payload.Reaction
	(*Event_Payload_Reaction_Reaction)(nil),         // 20: Event.Payload.Reaction.Reaction
	(*Event_Payload_Reaction_Reaction_Clap)(nil),    // 21: Event.Payload.Reaction.Reaction.Clap
}
var file_rtc_proto_depIdxs = []int32{
	9,  // 0: UpdateRecordingTrack.update:type_name -> UpdateRecordingTrack.Update
	8,  // 1: StoreEvent.event:type_name -> Event
	14, // 2: Event.payload:type_name -> Event.Payload
	10, // 3: UpdateRecordingTrack.Update.recording_started:type_name -> UpdateRecordingTrack.RecordingStarted
	11, // 4: UpdateRecordingTrack.Update.recording_finished:type_name -> UpdateRecordingTrack.RecordingFinished
	12, // 5: UpdateRecordingTrack.Update.processing_started:type_name -> UpdateRecordingTrack.ProcessingStarted
	13, // 6: UpdateRecordingTrack.Update.processing_finished:type_name -> UpdateRecordingTrack.ProcessingFinished
	15, // 7: Event.Payload.peer_state:type_name -> Event.Payload.PeerState
	16, // 8: Event.Payload.message:type_name -> Event.Payload.Message
	17, // 9: Event.Payload.recording:type_name -> Event.Payload.Recording
	18, // 10: Event.Payload.track_record:type_name -> Event.Payload.TrackRecord
	19, // 11: Event.Payload.reaction:type_name -> Event.Payload.Reaction
	0,  // 12: Event.Payload.TrackRecord.kind:type_name -> TrackKind
	1,  // 13: Event.Payload.TrackRecord.source:type_name -> TrackSource
	20, // 14: Event.Payload.Reaction.reaction:type_name -> Event.Payload.Reaction.Reaction
	21, // 15: Event.Payload.Reaction.Reaction.clap:type_name -> Event.Payload.Reaction.Reaction.Clap
	2,  // 16: RTC.CreateRoom:input_type -> Room
	3,  // 17: RTC.StartRecording:input_type -> RecordingParams
	4,  // 18: RTC.StopRecording:input_type -> RecordingLookup
	2,  // 19: RTC.CreateRoom:output_type -> Room
	5,  // 20: RTC.StartRecording:output_type -> Recording
	5,  // 21: RTC.StopRecording:output_type -> Recording
...
func file_rtc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rtc_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Event_Payload_TrackRecord); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_rtc_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*Event_Payload_PeerState_)(nil),
		(*Event_Payload_Message_)(nil),
		(*Event_Payload_Recording_)(nil),
		(*Event_Payload_TrackRecord_)(nil),
		(*Event_Payload_Reaction_)(nil),
	}
	file_rtc_proto_msgTypes[18].OneofWrappers = []interface{}{
